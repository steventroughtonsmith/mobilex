...
enum  {
    kIOHIDEventFieldGyroscopeX = IOHIDEventFieldBase(kIOHIDEventTypeGyroscope),
    kIOHIDEventFieldGyroscopeY,
    kIOHIDEventFieldGyroscopeZ
};

...
#define IOSFC_AVAILABLE_STARTING(x,y)
__BEGIN_DECLS
...
extern const CFStringRef kIOSurfaceIsGlobal					IOSFC_AVAILABLE_STARTING(__MAC_10_6, __IPHONE_3_0);
...
IOReturn IOSurfaceFlushProcessorCaches(IOSurfaceRef buffer)
	IOSFC_AVAILABLE_STARTING(__MAC_NA, __IPHONE_3_0);

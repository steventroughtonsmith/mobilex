...
/* Opens connection to the framebuffer service */
IOMobileFramebufferReturn 
IOMobileFramebufferClose(IOMobileFramebufferService servic);
...
IOMobileFramebufferReturn
IOMobileFramebufferSetGammaTable(IOMobileFramebufferRef connection, void* data);
	
IOMobileFramebufferReturn
IOMobileFramebufferGetGammaTable(IOMobileFramebufferRef connection, void* data);

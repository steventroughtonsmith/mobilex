...
#pragma pack()
	...
	__DeclareSendRpc(70300, "CopyApplicationList")
	...
	InP->Head.msgh_id = 70300;

	__BeforeSendRpc(70300, "CopyApplicationList")
	msg_result = mach_msg(&InP->Head, MACH_SEND_MSG|MACH_RCV_MSG|MACH_MSG_OPTION_NONE, (mach_msg_size_t)sizeof(Request), (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE, MACH_PORT_NULL);
	__AfterSendRpc(70300, "CopyApplicationList")
...
#pragma pack()
	...
	__DeclareSendRpc(70301, "LaunchApplication")
	...
	InP->Head.msgh_request_port = server;
	InP->Head.msgh_reply_port = mig_get_reply_port();
	InP->Head.msgh_id = 70301;

	__BeforeSendRpc(70301, "LaunchApplication")
	msg_result = mach_msg(&InP->Head, MACH_SEND_MSG|MACH_RCV_MSG|MACH_MSG_OPTION_NONE, msgh_size, (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE, MACH_PORT_NULL);
	__AfterSendRpc(70301, "LaunchApplication")
	if (msg_result != MACH_MSG_SUCCESS) {
		__MachMsgErrorWithoutTimeout(msg_result);
		{ return msg_result; }
	}
...
#pragma pack()
	...
	__DeclareSendRpc(70302, "CheckIn")
	...
	InP->Head.msgh_request_port = server;
	InP->Head.msgh_reply_port = mig_get_reply_port();
	InP->Head.msgh_id = 70302;

	__BeforeSendRpc(70302, "CheckIn")
	msg_result = mach_msg(&InP->Head, MACH_SEND_MSG|MACH_RCV_MSG|MACH_MSG_OPTION_NONE, (mach_msg_size_t)sizeof(Request), (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE, MACH_PORT_NULL);
	__AfterSendRpc(70302, "CheckIn")
	if (msg_result != MACH_MSG_SUCCESS) {
		__MachMsgErrorWithoutTimeout(msg_result);
		{ return msg_result; }
	}
...
#pragma pack()
	...
	__DeclareSendRpc(70303, "CopyScreenDimensions")
	...
	InP->Head.msgh_request_port = server;
	InP->Head.msgh_reply_port = mig_get_reply_port();
	InP->Head.msgh_id = 70303;

	__BeforeSendRpc(70303, "CopyScreenDimensions")
	msg_result = mach_msg(&InP->Head, MACH_SEND_MSG|MACH_RCV_MSG|MACH_MSG_OPTION_NONE, (mach_msg_size_t)sizeof(Request), (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE, MACH_PORT_NULL);
	__AfterSendRpc(70303, "CopyScreenDimensions")
	if (msg_result != MACH_MSG_SUCCESS) {
		__MachMsgErrorWithoutTimeout(msg_result);
		{ return msg_result; }
	}
...
#if ( __MigTypeCheck || __NDR_convert__ )
#if __MIG_check__Reply__MobileXRPC_subsystem__
#if !defined(__MIG_check__Reply__CallMethod_t__defined)
#define __MIG_check__Reply__CallMethod_t__defined
#ifndef __NDR_convert__int_rep__Reply__CallMethod_t__RetCode__defined
#if	defined(__NDR_convert__int_rep__MobileXRPC__kern_return_t__defined)
#define	__NDR_convert__int_rep__Reply__CallMethod_t__RetCode__defined
#define	__NDR_convert__int_rep__Reply__CallMethod_t__RetCode(a, f) \
	__NDR_convert__int_rep__MobileXRPC__kern_return_t((kern_return_t *)(a), f)
#elif	defined(__NDR_convert__int_rep__kern_return_t__defined)
#define	__NDR_convert__int_rep__Reply__CallMethod_t__RetCode__defined
#define	__NDR_convert__int_rep__Reply__CallMethod_t__RetCode(a, f) \
	__NDR_convert__int_rep__kern_return_t((kern_return_t *)(a), f)
#endif /* defined(__NDR_convert__*__defined) */
#endif /* __NDR_convert__int_rep__Reply__CallMethod_t__RetCode__defined */





mig_internal kern_return_t __MIG_check__Reply__CallMethod_t(__Reply__CallMethod_t *Out0P)
{

	typedef __Reply__CallMethod_t __Reply;
	if (Out0P->Head.msgh_id != 70404) {
	    if (Out0P->Head.msgh_id == MACH_NOTIFY_SEND_ONCE)
		{ return MIG_SERVER_DIED; }
	    else
		{ return MIG_REPLY_MISMATCH; }
...
#if defined(__NDR_convert__int_rep__Reply__CallMethod_t__RetCode__defined)
	if (Out0P->NDR.int_rep != NDR_record.int_rep)
		__NDR_convert__int_rep__Reply__CallMethod_t__RetCode(&Out0P->RetCode, Out0P->NDR.int_rep);
#endif	/* __NDR_convert__int_rep__Reply__CallMethod_t__RetCode__defined */
	{
		return Out0P->RetCode;
	}
}
#endif /* !defined(__MIG_check__Reply__CallMethod_t__defined) */
#endif /* __MIG_check__Reply__MobileXRPC_subsystem__ */
#endif /* ( __MigTypeCheck || __NDR_convert__ ) */


/* Routine CallMethod */
mig_external kern_return_t MXRCallMethod
(
	mach_port_t server,
	integer_t selector
)
...
#pragma pack()
...
#ifdef	__MIG_check__Reply__CallMethod_t__defined
	kern_return_t check_result;
#endif	/* __MIG_check__Reply__CallMethod_t__defined */

	__DeclareSendRpc(70304, "CallMethod")
	...
	InP->Head.msgh_request_port = server;
	InP->Head.msgh_reply_port = mig_get_reply_port();
	InP->Head.msgh_id = 70304;

	__BeforeSendRpc(70304, "CallMethod")
	msg_result = mach_msg(&InP->Head, MACH_SEND_MSG|MACH_RCV_MSG|MACH_MSG_OPTION_NONE, (mach_msg_size_t)sizeof(Request), (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE, MACH_PORT_NULL);
	__AfterSendRpc(70304, "CallMethod")
	if (msg_result != MACH_MSG_SUCCESS) {
		__MachMsgErrorWithoutTimeout(msg_result);
		{ return msg_result; }
	}
...
#if	defined(__MIG_check__Reply__CallMethod_t__defined)
	check_result = __MIG_check__Reply__CallMethod_t((__Reply__CallMethod_t *)Out0P);
	if (check_result != MACH_MSG_SUCCESS)
		{ return check_result; }
#endif	/* defined(__MIG_check__Reply__CallMethod_t__defined) */

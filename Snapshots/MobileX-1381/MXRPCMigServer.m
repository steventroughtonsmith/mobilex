...
#pragma pack()
	...
	kern_return_t RetCode;
	__DeclareRcvRpc(800000, "CopyApplicationList")
	__BeforeRcvRpc(800000, "CopyApplicationList")
	...
	__AfterRcvRpc(800000, "CopyApplicationList")
}
...
#pragma pack()
	...
	__DeclareRcvRpc(800001, "LaunchApplication")
	__BeforeRcvRpc(800001, "LaunchApplication")
	...
	__AfterRcvRpc(800001, "LaunchApplication")
}
...
#pragma pack()
	...
	__DeclareRcvRpc(800002, "CheckIn")
	__BeforeRcvRpc(800002, "CheckIn")
...
#pragma pack()
	...
	__DeclareRcvRpc(800003, "CopyScreenDimensions")
	__BeforeRcvRpc(800003, "CopyScreenDimensions")
	...
	OutP->Head.msgh_size = (mach_msg_size_t)(sizeof(Reply));
	__AfterRcvRpc(800003, "CopyScreenDimensions")
}
...
#pragma pack()
	...
	__DeclareRcvRpc(800004, "CallMethod")
	__BeforeRcvRpc(800004, "CallMethod")
	...
	__AfterRcvRpc(800004, "CallMethod")
}


extern boolean_t MobileXRPC_server(
		mach_msg_header_t *InHeadP,
		mach_msg_header_t *OutHeadP);

extern mig_routine_t MobileXRPC_server_routine(
		mach_msg_header_t *InHeadP);
	...
	(mach_msg_header_t *InHeadP, mach_msg_header_t *OutHeadP)
{
	...
	if ((InHeadP->msgh_id > 800004) || (InHeadP->msgh_id < 800000) ||
	    ((routine = _MXRPCCall_MobileXRPC_subsystem.routine[InHeadP->msgh_id - 800000].stub_routine) == 0)) {
	...
	(mach_msg_header_t *InHeadP)
{
	...
	msgh_id = InHeadP->msgh_id - 800000;
